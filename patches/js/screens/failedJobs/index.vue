    ...
    export default {
        ...
        methods: {
            ...
            loadJobs(starting = 0, refreshing = false) {
                ...
                var nameQuery = this.jobSearchPhrase ? 'query=' + encodeURIComponent(this.jobSearchPhrase) + '&' : '';

                this.$http.get(Horizon.basePath + '/api/jobs/failed?' + tagQuery + nameQuery + 'starting_at=' + starting)
                    .then(response => {
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2">
                    <div class="form-control-with-icon">
                        ...
                        <input type="text" class="form-control w-100" v-model="jobSearchPhrase" placeholder="Search Jobs...">
                    </div>
